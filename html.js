const init = () => {
  ...
  if (targetElement) {
    ...
    <div class="my-component centered-column">
      ...
      <button id="filterNotFollowingBackButton" class="filter">Filter Non-Followers</button>
      <button id="filterNotFollowedBackButton" class="filter">Filter Not Followed Back</button>
